...
public class ErrorControllerClass implements ErrorController {
	...
	// if the user tries to visit any other page which does not exist, then it will
	// first ask the user to log in, this is not a mistake, its a feature, no
	// drawback of this could be found, so leaving is as it is.
